        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('Editar Explicação'),
                Text(widget.explicacao.titulo,maxLines: 2,style: TextStyle(fontSize: 16),),
              ],
            ),
          ),
        ],
              ...
              FutureBuilder<List<FUser>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Expanded(child: Center(child: Text('Não tem Explicandos atualmente')));
                  } else {
                ...
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                      style: buttonPrincipalSquare,
                      onPressed: () async {
                        if(selectedUsers.length >= 1 && formkey.currentState!.validate()){
                          setState(() {
                            erro = false;
                            loading = true;
                          });
                        ...
                        else if(selectedUsers.length < 1 && !formkey.currentState!.validate()){
                          print('Selecione pelo menos 1 explicando para marcar uma explicação e meta uma duração válida');
                          setState(() {
                          ...
                          print('Selecione pelo menos 1 explicando para marcar uma explicação');
                          setState(() {
