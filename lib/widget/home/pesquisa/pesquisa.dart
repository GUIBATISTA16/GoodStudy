                                    ...
                                    showDialog(context: context, builder: (context){
                                      return AlertDialog(
                                        ...
                                        content: Container(
                                          ...
                                          child: PedidosPendentesLista(),
                                        ),
                                      );
                                    });
                                  },
                                  style: buttonPrincipalSquare,
                                  child: TextoPrincipal(text: 'Pedidos Pendentes'),
                                ),
                              ),
                            ],
                          )
            ...
            child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(child: Text('Nenhum explicador encontrado.'));
                } else {
                  return Container(
