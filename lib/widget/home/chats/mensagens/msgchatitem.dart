...
import 'package:projeto_goodstudy/widget/videoplayer.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: widget.msg.remetente != '1' ? Column(
                ...
                if (widget.msg.remetente != globals.userlogged?.uid)
                  Padding(
                    ...
                    child: SizedBox(
                      width: 40,
                      height: 40,
                      child: FotoPerfil(photoUrl: widget.destinatarioPhotoUrl,size: 50,),
                    ),
                  ),
        ...
        children: [
          Text(widget.msg.texto!,style: TextStyle(fontSize: 11),)
        ],
      ),
    );
  }
