        ...
        child: Carde(
          child: ListTile(
            leading: Stack(
              ...
              children: [
                Positioned(child: SizedBox(child: FotoPerfil(photoUrl: widget.explicador.photoUrl,size: 30,loading: false,),width: 35,height: 35,)),
                Positioned(child: SizedBox(child: FotoPerfil(photoUrl: widget.listUsers[0].photoUrl,size: 30,loading: false), width: 35,height: 35,),left: 10,top: 10,),
              ],
            ),
                      ...
                      if(listMsgs.last.remetente != '1'){
                        if(listMsgs.last.remetente != globals.userlogged?.uid){
                          ...
                          if(listMsgs.last.tipo == 'texto'){
                            ...
                            return Text('Você enviou uma imagem', maxLines: 2,);
                          }
                          else if(listMsgs.last.tipo == 'video'){
                            return Text('Você enviou um video', maxLines: 2,);
                          }
                          else{
                            return Text('Você enviou um documento', maxLines: 2,);
                          }
                        }
                      }
                      else{
