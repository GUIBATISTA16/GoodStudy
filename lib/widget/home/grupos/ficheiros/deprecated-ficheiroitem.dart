...
class ItemFicheiroGrupo extends StatefulWidget {
  final MensagemObject msg;

  const ItemFicheiroGrupo({
    super.key,
    required this.msg,
  });

  @override
  State<ItemFicheiroGrupo> createState() => _ItemFicheiroGrupoState();
}

class _ItemFicheiroGrupoState extends State<ItemFicheiroGrupo> {
              ...
              child: GestureDetector(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Icon(size: 30, Icons.play_arrow, color: Colors.white),
                  ],
                ),
              ),
            ),
