      ...
      return AlertDialog(
        ...
        title: Column(
          ...
          children: [
            Row(
              children: [
                Text("Enviar Pedido a", style: TextStyle(fontSize: 24.0)),
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text(widget.explicador.nome!, style: TextStyle(fontSize: 21)),
                ),
              ],
            )
          ],
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(widget.explicador.nome!, style: TextStyle(fontSize: 26)),
                            Text(widget.explicador.especialidade!, style: TextStyle(fontSize: 19)),
                            Text('Anos de Experiência: ${widget.explicador.anosexp}', style: TextStyle(fontSize: 15)),
                            Text(widget.explicador.descricao!, style: TextStyle(fontSize: 13)),
                          ],
                        ),
                      ),
                    ),
