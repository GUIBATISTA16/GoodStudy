        ...
        content: Row(
          ...
          children: [
            ElevatedButton(
              ...
              child: TextoPrincipal(text: 'Terminar',),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.pop(context);
              ...
              child: TextoPrincipal(text: 'Cancelar',),
            )
          ],
        )
      );
              ...
              return AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10), // Espaçamento opcional entre as estrelas e o botão
                    ElevatedButton(
                      onPressed: () async {
                      ...
                      child: TextoPrincipal(text: 'Enviar'),
                    ),
                  ],
                ),
              );
