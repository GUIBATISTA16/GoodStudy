  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextoPrincipal(text: 'O seu Perfil',),
        actions: [
          Padding(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            !editing
                            ? Text(globals.userlogged!.especialidade!, style: TextStyle(fontSize: 19))
                            : FormField<String>(
                            ...
                            !editing
                            ? Text('Anos de Experiência: ${globals.userlogged!.anosexp}', style: TextStyle(fontSize: 15))
                            : Padding(
                            ...
                            ? Padding(
                              ...
                              child: Text(globals.userlogged!.descricao!, style: TextStyle(fontSize: 13)),
                            )
                            : Padding(
